...
class SingleRNN(nn.Module):
    ...
    def __init__(self, rnn_type, input_size, hidden_size, dropout=0, bidirectional=False):
        ...
        self.rnn = getattr(nn, rnn_type)(input_size, hidden_size, 2, dropout=dropout, batch_first=True, bidirectional=bidirectional)
...
def test_model():
    ...
    x = torch.rand(2, 4, 76672)  # (batch, num_mic, length)
